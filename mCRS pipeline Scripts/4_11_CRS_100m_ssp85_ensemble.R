...
CRS.computation <- function(dist, env, scenario, env_startcol, env_endcol,
  ...
  dat <- droplevels(dist)
  sp <- droplevels(unique(dat$PopID)) #Identify unique populations
  ...
  for (i in 1:length(sp)) {
    for (j in 1:nlevels(as.factor(unique(env$Date)))) {
      ...
      tmp <- unique(dat[dat$PopID == sp[[i]],]) #IDs for relevant population
    ...
    write.csv(tmp.data, file=paste0('Results/Ensemble/CRS/',
                                    scenario,'/',scenario,'_',
                                    as.character(sp[[i]]),'_',
                                    depth,'m.csv'),row.names=F)
...
# save.image('RData/CRS_results/CRScomputation_ssp26_10m_ensemble.RData')
...
# save.image('RData/CRS_results/CRScomputation_ssp26_50m_ensemble.RData')
...
# save.image('RData/CRS_results/CRScomputation_ssp26_100m_ensemble.RData')
...
# save.image('RData/CRS_results/CRScomputation_ssp26_150m_ensemble.RData')
...
#                                           env_startcol=9, env_endcol=12,
#                                           refyear_start='1850-01-01', refyear_end='2000-12-31', depth = 10)
# save.image('RData/CRS_results/CRScomputation_ssp45_10m_ensemble.RData')
# 
# ## 2)
...
#                                  env_startcol=9, env_endcol=12,
#                                  refyear_start='1850-01-01', refyear_end='2000-12-31', depth = 50)
# save.image('RData/CRS_results/CRScomputation_ssp45_50m_ensemble.RData')
# 
# ##3)
...
#                                  env_startcol=9, env_endcol=12,
#                                  refyear_start='1850-01-01', refyear_end='2000-12-31', depth = 100)
# save.image('RData/CRS_results/CRScomputation_ssp45_100m_ensemble.RData')
# 
# ##4)
...
#                                  refyear_start='1850-01-01', refyear_end='2000-12-31', depth = 150)
# 
# save.image('RData/CRS_results/CRScomputation_ssp45_150m_ensemble.RData')
...
#                              env_startcol=9, env_endcol=12,
#                              refyear_start='1850-01-01', refyear_end= '2000-12-31', depth = 10)
# save.image('RData/CRS_results/CRScomputation_ssp85_10m_ensemble.RData')
...
#                                  env_startcol=9, env_endcol=12,
#                                  refyear_start='1850-01-01', refyear_end= '2000-12-31', depth = 50)
# save.image('RData/CRS_results/CRScomputation_ssp85_50m_ensemble.RData')
...
CRS.ssp85.100m.ensemble <- CRS.computation(dist=Populations,
                                 ...
                                 env_startcol=9, env_endcol=12,
                                 refyear_start='1850-01-01', refyear_end= '2000-12-31', depth = 100)
save.image('RData/CRS_results/CRScomputation_ssp85_100m_ensemble.RData')
...
#                                  env_startcol=9, env_endcol=12,
#                                  refyear_start='1850-01-01', refyear_end= '2000-12-31', depth = 150)
#save.image('RData/CRS_results/CRScomputation_ssp85_150m_ensemble.RData')
