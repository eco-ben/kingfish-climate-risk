...
write.csv(PremeanDT, file = 'Results/mCRS-DeltamCRS RAW/DeltaCRS_mCRS_RAW_depth_together.csv', row.names = F)
write.csv(CRS.dt, file = 'Results/mCRS-DeltamCRS RAW/DeltaCRS_PopValues_depth_together.csv', row.names = F)
